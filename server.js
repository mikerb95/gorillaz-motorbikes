...
// Basic demo users (in-memory). Replace with DB later.
const users = [
  {
    id: uuidv4(),
    email: 'miembro@gorillaz.co',
    password: 'gorillaz123', // No uses texto plano en producción
...
app.listen(PORT, () => {
  console.log(`Gorillaz Motorbikes escuchando en http://localhost:${PORT}`);
});
